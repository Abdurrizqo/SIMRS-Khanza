...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.Permintaan", "No.Rawat", "Pasien", "Jenis Kelamin", "Umur", "Permintaan", "Jam", "Sampel", "Jam", "Hasil", "Jam", "Kode Dokter", "Dokter Perujuk", "Poli Registrasi", "Informasi Tambahan", "Diagnosis Klinis", "Kode Bayar", "Jenis Bayar"
        }) {
            @Override
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{
            "No.Permintaan", "No.Rawat", "Pasien", "Jenis Kelamin", "Umur", "Pemeriksaan", "Permintaan", "Jam", "Sampel", "Jam", "Hasil", "Jam", "Kode Dokter", "Dokter Perujuk", "Poli Registrasi", "Informasi Tambahan", "Diagnosis Klinis", "Kode Bayar", "Jenis Bayar"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
        ...
        tabMode3 = new DefaultTableModel(null, new Object[]{
            "No.Permintaan", "No.Rawat", "Pasien", "Jenis Kelamin", "Umur", "Permintaan", "Jam", "Sampel", "Jam", "Hasil", "Jam", "Kode Dokter", "Dokter Perujuk", "Kamar Terakhir", "Informasi Tambahan", "Diagnosis Klinis", "Kode Bayar", "Jenis Bayar"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
        ...
        tabMode4 = new DefaultTableModel(null, new Object[]{
            "No.Permintaan", "No.Rawat", "Pasien", "Jenis Kelamin", "umur", "Pemeriksaan", "Permintaan", "Jam", "Sampel", "Jam", "Hasil", "Jam", "Kode Dokter", "Dokter Perujuk", "Kamar Terakhir", "Informasi Tambahan", "Diagnosis Klinis", "Kode Bayar", "Jenis Bayar"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
...
private void tbRadiologiRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbRadiologiRalanKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,reg_periksa.umurdaftar,reg_periksa.sttsumur,pasien.nm_pasien,pasien.jk,permintaan_radiologi.tgl_permintaan,"
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        + rs.getString("nm_pasien"), rs.getString("jk"), rs.getString("umurdaftar") + " " + rs.getString("sttsumur"), rs.getString("tgl_permintaan"), rs.getString("jam_permintaan"),
    ...
    private void tampil2() {
        ...
        try {
            semua = CrDokter.getText().trim().equals("") && CrPoli.getText().trim().equals("") && TCari.getText().trim().equals("");
            ps = koneksi.prepareStatement(
                    "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,reg_periksa.umurdaftar,reg_periksa.sttsumur,"
                    + "pasien.nm_pasien,pasien.jk,jns_perawatan_radiologi.nm_perawatan,permintaan_radiologi.tgl_permintaan,reg_periksa.kd_pj,penjab.png_jawab,"
    ...
    private void tampil4() {
        ...
        try {
            ...
            if (cmbStatus.getSelectedIndex() == 0) {
                ps = koneksi.prepareStatement(
                        "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,reg_periksa.umurdaftar,reg_periksa.sttsumur,"
                        + "pasien.jk,pasien.nm_pasien,jns_perawatan_radiologi.nm_perawatan,permintaan_radiologi.tgl_permintaan,reg_periksa.kd_pj,penjab.png_jawab,"
                        + "if(permintaan_radiologi.jam_permintaan='00:00:00','',permintaan_radiologi.jam_permintaan) as jam_permintaan,permintaan_radiologi.tgl_sampel,"
                        + "if(permintaan_radiologi.jam_sampel='00:00:00','',permintaan_radiologi.jam_sampel) as jam_sampel, permintaan_radiologi.tgl_hasil,"
                        + "if(permintaan_radiologi.jam_hasil='00:00:00','',permintaan_radiologi.jam_hasil) as jam_hasil,"
